...
const CAS: Cas[] = [
  ...
  },
  {
    ...
    description:
      "Une note vocale entre deux rendez-vous, et l'agent prépare le devis chiffré, prêt à valider. Le premier qui répond signe.",
    visuel: null,
  ...
  },
  {
    ...
    description:
      "L'enregistrement devient un CR structuré, sans que personne ne s'y colle : décisions, qui fait quoi, pour quand.",
    visuel: null,
  ...
  },
  {
    ...
    description:
      "Une fiche de synthèse client, générée à la demande : historique, encours, points de friction, en une page.",
    visuel: null,
    composition: <CompositionFicheClient />,
  },
];

export function CasAutomatisations() {
    ...
    >
      ...
      <div data-apparition="" className="max-w-[680px]">
        ...
        <p className="mt-4 text-[16.5px] leading-[1.58] text-body-sur-ink">
          Six situations de votre semaine, prises en charge par des agents qui tournent sur vos outils.
        </p>
      </div>
      ...
      {/* CTA intermédiaire, à la sortie des cas : quatre écrans séparent
          le héro des offres, ce lien mène aux deux voies proposées. */}
      <div className="mt-7">
        <LienOffres />
      </div>
    </section>
...
/**
 * Lien secondaire vers les offres : idiome du lien turquoise sur l'encre
