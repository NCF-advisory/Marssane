...
/**
 * Héro « formation » : colonne texte (kicker, H1, CTA) à gauche,
 * vidéo (HeroMedia) à droite, puis bandeau chiffres sous la grille. Fond
    ...
    <section className="relative isolate mx-auto max-w-[1260px] px-10 pb-10 pt-[74px]">
      ...
      <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[0.9fr_1.2fr]">
        ...
        <div className="max-w-[530px]">
          ...
          <h1 className="mt-[18px] text-[30px] font-extrabold leading-[1.04] tracking-[-0.03em] sm:text-[44px] lg:text-[54px]">
            Dirigeant de PME,{" "}
