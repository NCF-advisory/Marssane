...
/**
 * Les cinq lignes du quotidien qui changent après l’implémentation. Reprises des
...
const PAIRES: { sans: string; apres: string }[] = [
  ...
  },
  {
    ...
    apres: "Les relances partent toutes seules",
  },
  {
    sans: "Un abonnement IA qui dort",
    apres: "Des agents qui travaillent sur vos dossiers",
  },
  {
 ...
 */
export function AvantApresImplementation() {
  return (
    <section className="relative isolate mx-auto max-w-[1180px] px-6 pb-2 pt-[84px] sm:px-10">
      ...
      >
        <div className="max-w-[640px]">
          ...
          <h2 className="mt-[20px] text-[30px] font-extrabold leading-[1.08] tracking-[-0.025em] sm:text-[38px]">
            Ce qui change quand le système{" "}
        ...
        <RendezVousTrigger className="flex-none self-start lg:self-auto">
      ...
      <div className="mt-[34px] grid grid-cols-1 gap-9 md:grid-cols-2 md:gap-8">
        ...
        >
          ...
          <p className="mt-2 text-[15px] leading-[1.55] text-body-sur-ink">
            Un système construit pour vous, qui tourne dès les premières semaines.
          </p>
          <ul className="mt-5 flex flex-col gap-3">
            {PAIRES.map((paire) => (
              <li
