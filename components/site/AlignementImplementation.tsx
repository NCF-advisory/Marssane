...
const SATELLITES: { nom: string; x: number; y: number }[] = [
  { nom: "Diagnostic de votre semaine", x: 22, y: 58 },
  { nom: "Agents IA sur mesure", x: 78, y: 50 },
  { nom: "Sur vos outils", x: 17, y: 19 },
  { nom: "Passation accompagnée", x: 83, y: 19 },
  { nom: "Maintenance au choix", x: 14, y: 80 },
  { nom: "Formation en option", x: 84, y: 84 },
];
 ...
 */
export function AlignementImplementation() {
  return (
    <section className="relative isolate mx-auto max-w-[1180px] px-6 pb-2 pt-[84px] sm:px-10">
      ...
      <div data-apparition="" className="max-w-[680px]">
        ...
        <p className="mt-4 text-[16.5px] leading-[1.58] text-body-sur-ink">
          Le système tourne sur vos outils. Vous choisissez une passation accompagnée pour votre équipe ou une maintenance assurée par Marssane, selon vos besoins et le temps dont vous disposez.
        </p>
      </div>
