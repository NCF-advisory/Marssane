...
export function PourFaireQuoi() {
  return (
    ...
    >
      ...
      <span
        aria-hidden
        className="absolute left-[15.25px] top-0 -z-[1] hidden h-[52px] w-[1.5px] bg-line-sur-ink lg:block"
      />
      <span
        aria-hidden
        ...
        style={{
          backgroundImage:
            "repeating-linear-gradient(90deg,var(--color-line-sur-ink) 0 8px,transparent 8px 15px)",
        }}
      />
      <PlusMark
        variant="turquoise"
      ...
      <span
        aria-hidden
        className="absolute left-[546.25px] top-[63px] -z-[1] hidden h-[34px] w-[1.5px] bg-line-sur-ink lg:block"
      />
      <PlusMark
        variant="grey-sur-ink"
        size={16}
        className="absolute right-[150px] top-[56px] hidden lg:block"
      />

      <div className="max-w-[680px]">
        <Kicker className="text-faint-sur-ink!">Pour faire quoi · votre semaine type</Kicker>
        ...
        <p className="mt-4 text-[16.5px] leading-[1.58] text-body-sur-ink">
          Deux situations que vous vivez chaque semaine. Pendant la formation,
