...
type ChiffresImplementationProps = {
  kicker?: string;
  titre?: string;
 ...
 */
export function ChiffresImplementation({
  kicker = "Marssane en chiffres",
  titre = "L'IA bien implémentée, voilà ce que ça change.",
  motSurligne = "ça change",
  stats = STATS,
}: ChiffresImplementationProps = {}) {
