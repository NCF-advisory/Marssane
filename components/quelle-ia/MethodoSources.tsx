  ...
  return (
    <section className="relative isolate mx-auto max-w-[1180px] px-10 pb-2 pt-[84px]">
      <div className="max-w-[640px]">
        <Kicker className="text-faint-sur-ink!">Méthode &amp; sources</Kicker>
      ...
      <div className="mt-6 flex flex-wrap items-center gap-x-6 gap-y-2 font-mono text-[12px] uppercase tracking-[0.08em] text-faint-sur-ink">
