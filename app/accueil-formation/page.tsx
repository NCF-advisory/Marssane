...
// Métadonnées de la landing formation conservées pour comparaison.
const HOME_TITLE = "Formation IA pour dirigeants de PME à Lyon | Marssane";
const HOME_DESCRIPTION = "Formation IA pour dirigeants de PME près de Lyon : 2 séances de 3 h 30 pour pratiquer Claude sur vos mails, documents et tâches métier, avec Marssane.";
    ...
    <>
      ...
      <JsonLd data={{
        ...
        "@graph": [
          ...siteEntities,
          {
            ...webPage({ path: "/accueil-formation", name: HOME_TITLE, description: HOME_DESCRIPTION }),
