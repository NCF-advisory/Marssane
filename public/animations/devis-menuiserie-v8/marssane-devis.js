...
const loadFont=()=>fontReady??=(async()=>{
 const face=new FontFace('MarssaneJakarta',`url(${fontURL})`,{weight:'200 800',style:'normal'});
...
:host{display:block;width:100%;--schema-background:#0D1118;--schema-label:#FFFFFF;--schema-wire:#466366;--schema-signal:#00D1B6;--schema-border:#D8E4DB;--schema-control:#AAC4C0;color:#152C35;font-family:MarssaneJakarta,'Plus Jakarta Sans',Arial,sans-serif}
:host([theme="light"]){--schema-background:#FFFFFF;--schema-label:#152C35;--schema-wire:#829E93;--schema-signal:#008D78;--schema-border:#B6CBBF;--schema-control:#46695C}
...
${wires.map((w,i)=>`<path id="wire${i}" class="wire" d="${w.d}"/><g id="signal${i}" opacity="0"><path class="signal" d="${w.d}" opacity=".5"/><g id="particle${i}"><circle r="10" fill="var(--schema-signal)" opacity=".16"/><circle r="4.5" fill="var(--schema-signal)"/></g></g>`).join('')}</g>
...
<g data-node="agent"><circle cx="399" cy="267" r="62" fill="var(--schema-background)" stroke="var(--schema-wire)" stroke-width="1.5"/><circle id="agentRing" cx="399" cy="267" r="62" fill="none" stroke="var(--schema-signal)" stroke-width="3" stroke-dasharray="59 330" opacity="0"/><g clip-path="url(#portrait)"><circle cx="399" cy="267" r="54" fill="#0E0E12"/><image href="${portrait}" x="307.2" y="210.6" width="183.6" height="183.6"/></g><text x="399" y="187" text-anchor="middle" font-size="30" fill="var(--schema-label)">Marco</text></g>
...
<g data-node="devis">
 ...
 <rect id="docBorder" x="624" y="271" width="296" height="211" rx="9" fill="#FFFFFF" stroke="var(--schema-border)" stroke-width="1.5"/>
 <rect id="resultFlash" x="624" y="271" width="296" height="211" rx="9" fill="var(--schema-signal)" opacity="0"/>
...
export class MarssaneDevis extends HTMLElement{
 ...
 border(id,value){this.nodes[id].style.stroke=value>.1?'#00B99D':'var(--schema-border)';}
 draw(t){
